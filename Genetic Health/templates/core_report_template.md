# DNA Decoder: Core Report

**Your Personalized Genetic Wellness Guide**
...
**What's Inside:**
- {lifestyle_findings_count} lifestyle and wellness insights
- {pharma_findings_count} medication response notes
...
## What Your Genes Suggest About...

### ☕ Caffeine Metabolism

**Your Pattern:** {caffeine_metabolism_summary}

{caffeine_details}

**What This Means:**
{caffeine_interpretation}
...
**Your Pattern:** {methylation_summary}
...
### 🛡️ Detoxification & Antioxidant Systems

**Your Pattern:** {detox_summary}

{detox_details}

**What This Means:**
{detox_interpretation}
...
### ⚖️ Weight, Glucose & Metabolism

**Your Pattern:** {metabolism_summary}

{metabolism_details}

**What This Means:**
{metabolism_interpretation}
...
- ⭐⭐ Emerging evidence (preliminary research)
...
Based on your genetic patterns, these may be worth exploring with medical guidance:

{supplement_suggestions_table}

**Important:**
- These are considerations, not prescriptions
- Quality and dosing matter—work with a practitioner
...
### Data Quality Notes
- **SNPs Analyzed:** {snps_analyzed}
- **Coverage:** Direct-to-consumer raw data covers common variants but misses rare mutations
- **Confirmation:** High-priority findings should be confirmed with clinical-grade testing
- **Context Matters:** Diet, lifestyle, environment, and other genes all influence outcomes
...
- Flagged variants from clinical databases (ClinVar)
...
**Disclaimer:** This report is for educational and informational purposes only. It is not intended to diagnose, treat, cure, or prevent any disease. Always consult with a qualified healthcare provider before making decisions about your health based on genetic information.
